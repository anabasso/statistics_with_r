...
inference(y = weeks, data = nc, type = 'ci', statistic = 'mean', method = 'theoretical', conf_level = 0.99)
```
...
inference(y = weeks, data = nc, type = 'ci', statistic = 'mean', method = 'theoretical', conf_level = 0.9)
```
...
```{r gained-mature-ht}
# type your code for the Exercise here, and Knit
inference(y = gained, x = mature, data = nc, type = 'ht', statistic = 'mean', method = 'theoretical', null = 0, alternative = 'twosided')
```
...
```{r pick-your-own}
# type your code for the Exercise here, and Knit
inference(y = weight, x = mature, data = nc, type = 'ht', statistic = 'mean', method = 'theoretical', null = 0, alternative = 'twosided')
```
